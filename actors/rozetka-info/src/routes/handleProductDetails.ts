...
import { tableRowsOrListItemsIntoArray, getDatasetItemTemplate } from '../tools';
import { CSS_SELECTORS } from '../consts';
...
export const handleProductDetails = async ({
    ...
    console.log('Product:' + $('script[data-seo="Product"]').text());
