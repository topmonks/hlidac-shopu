...
import { enqueueLastPage } from './index';
import { getOrIncStatsValue } from '../../tools';
import { MAX_PAGE_COUNT,
    BAD_HARDWARE_PAGE_URL, GOOD_HARDWARE_PAGE_URL } from '../../consts'
...
export const countProductsOrSplitPriceRange = async (
    $: cheerio.Selector,
    url: string,
