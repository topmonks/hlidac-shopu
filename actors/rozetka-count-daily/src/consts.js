...
export const CATEGORY_CELL_SELECTOR = '.tile-cats__heading, li.portal-grid__cell rz-image-tile > a, rz-widget-tabs:nth-child(2) .portal-cats__list a';
...
export const CELEBRATION_GOODS = 'https://rozetka.com.ua/podarki-i-tovary-dlya-prazdnikov/c80260/';

export const GAMER_GOODS_URL = 'https://rozetka.com.ua/game-zone/c80261/';
export const RESTAURANT_GOODS_URL = 'https://rozetka.com.ua/restorani-i-produktovie-seti/c4660651/';
