...
describe("Shops", () => {
  ...
  describe("shopName", () => {
    [
      ...
      it(`${itemUrl} should return ${expected}`, () =>
        expect(shopName(itemUrl)).to.equal(expected))
    );
  });
  ...
  describe("shopOrigin", () => {
    [
      ...
      [
        "https://www.hornbach.sk/p/jadrova-omietka-rucna-082-25-kg/10165632/",
        "hornbach.sk"
      ],
      [
  ...
  describe("itemSlug", () => {
    [
      ["https://www.eduscho.at/barista-caffe-crema-2x-1-kg-ganze-bohne-p400091018.html", "barista-caffe-crema-2x-1-kg-ganze-bohne-p400091018"],
      ["https://www.notino.cz/rexaline/premium-line-killer-x-treme-corrector-omlazujici-gel-na-ocni-okoli/", "premium-line-killer-x-treme-corrector-omlazujici-gel-na-ocni-okoli"],
